...
public class adapters extends RecyclerView.Adapter<adapters.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            descripcionanuncios =(TextView)itemView.findViewById(R.id.descripcionfavoritos);
            costoanuncios = (TextView)itemView.findViewById(R.id.preciofavoritos);
            cantidadanuncios = (TextView)itemView.findViewById(R.id.cantidadfavoritos);
