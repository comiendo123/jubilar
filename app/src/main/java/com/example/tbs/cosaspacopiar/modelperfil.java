...
public class modelperfil {private Integer imgmisanuncios;
    ...
    public modelperfil(String title, String descripcirrron, String est, int coco){

    }
    public modelperfil( String titulomisanuncios, String descripcionmisanuncios, String costomisanuncios, String categoria,String cantidad, int imgmisanuncios){
