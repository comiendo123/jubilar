...
public class miscitas extends Fragment {
    ...
    public ArrayList<modelsmiscitas> obtencion(){
        ...
        listarecycler.add(new modelsmiscitas("rsa","vcds","gfdsvbnmiop.ol,ikmunjyhbtgv","loco","bici","","2enero","asd","",R.drawable.coco));
        listarecycler.add(new modelsmiscitas("","","","","","","2enero","asd","",R.drawable.coco));
        listarecycler.add(new modelsmiscitas("uytre","","","","","","2enero","asd","",R.drawable.coco));
        listarecycler.add(new modelsmiscitas("","","","","","","2enero","asd","",R.drawable.coco));
        listarecycler.add(new modelsmiscitas("","","","","","","2enero","asd","",R.drawable.coco));
        listarecycler.add(new modelsmiscitas("","","","","","","2enero","asd","",R.drawable.coco));
        listarecycler.add(new modelsmiscitas("","","","","","","2enero","asd","",R.drawable.coco));
