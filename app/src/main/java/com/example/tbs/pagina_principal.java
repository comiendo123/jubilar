...
import com.example.tbs.cosaspacopiar.perfildeverdad;

import java.util.ArrayList;

public class pagina_principal extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, misanuncios.OnFragmentInteractionListener,
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.publicaranuncio) {
           ...
           Intent mismensajes= new Intent(this,Chats.class);
           startActivity(mismensajes);

        } else if (id == R.id.nav_misfavoritos) {

        } else if (id == R.id.mi_perfil) {
            Intent irperfil = new Intent (this, perfildeverdad.class);
